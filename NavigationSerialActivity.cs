...
{
    [Activity(Label = "NavigationSerialActivity")]
    public class NavigationSerialActivity : MainActivity, IOnMapReadyCallback
    {
        ...
        protected async override void OnResume()
        {
            ...
            serialIoManager.DataReceived += (sender, e) =>
            {
                RunOnUiThread(() =>
                {
                    ...
                    if (flight_mode == 3 && fixWayPoint == false) WriteData(send_buffer);
        ...
        void WriteData(byte[] data)
        {
            ...
            {
                bluetoothData1.Text = ex.Message;
            }
        }
